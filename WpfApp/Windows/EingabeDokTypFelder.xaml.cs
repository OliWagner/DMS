...
namespace WpfApp
{
    ...
    /// </summary>
    public partial class EingabeDokTypFelder : Window
    {
        private List<EingabeTabellenfelder> alleDatensaetze;
        private List<string> alleTabellenNamen;

        public Dictionary<string, string> Werte { get; set; }
        
        public EingabeDokTypFelder()
        {
            InitializeComponent();
        }
        ...
        private void btnSpeichern_Click(object sender, RoutedEventArgs e)
        {
            ...
            //HIer benötigen wir die Werte erst wenn der Speichern Button für den Dokumententyp gedrückt wird.
            Werte = werte;
